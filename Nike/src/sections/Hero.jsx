  ...
  return (
    ...
    >
      <div className="relative 
            xl:w-2/5 flex flex-col justify-center item-start w-full max-xl:padding-x pt-28">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stst, index) => (
            <div key={index}>
              <p className="text-4xl font-palanquin font-bold">{stst.value}</p>
              <p className="leading-7 font-montserrat text-slate-gray">{stst.label}</p>
            </div>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        <div className="flex justify-center sm:gap-6 gap-4 absolute -bottom-[5%] sm: left-[10%] max-sm:px-6">
